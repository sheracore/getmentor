...
from getmentor.utilities.db.fields import MonthField, YearField
...
class AbstractDurationModel(models.Model):
    ...
    @property
    def total_year(self):
        return self._total_month // 12 if self._total_month else None
    ...
    def _total_month(self):
        if not self.start_year and not self.start_month:
            return
