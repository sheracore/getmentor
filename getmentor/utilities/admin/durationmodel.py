from .basemodels import UserBaseModelAdmin


class UserDurationAdmin(UserBaseModelAdmin):
    fields = [
        'is_current',
        'start_year',
        'end_year',
    ...
    def __init__(self, *args, **kwargs):
        parent_class = UserBaseModelAdmin
        super(UserDurationAdmin, self).__init__(*args, **kwargs)
